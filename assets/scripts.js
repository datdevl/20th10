...
if (!window["Heartlove"]) {
  window.Heartlove = {
    data: {
      messages:[
  "Chúc Mẹ yêu luôn mạnh khỏe và hạnh phúc 💖",
  "20/10 – Chúc Mẹ rạng rỡ, vui vẻ mỗi ngày 🌸",
  "Con yêu Mẹ nhiều lắm 💐",
  "Cảm ơn Mẹ vì tất cả yêu thương 🌷",
  "Chúc Mẹ 20/10 trọn vẹn và hạnh phúc 💞",
  "Mẹ là người phụ nữ tuyệt vời nhất 💝",
  "Chúc Mẹ luôn vui, khỏe và bình an 🌻"
],
      images: [],
      heartColor: "#ff9090",
    },
